...
export class ClientService {
  ...
  async create(dto: CreateClientDto) {
    ...
    const client = await this.clientRepo.create({
      ...dto,
      tenant,
      approved_by: approver as User | null,
  ...
  async update(id: string, dto: Partial<CreateClientDto>) {
    ...
    if (dto.country_of_residence) updatedDto.country_of_residence = dto.country_of_residence;
    if (dto.agency) updatedDto.agency = dto.agency;
    if (dto.school) updatedDto.school = dto.school;
    if (dto.accommodation_type) updatedDto.accommodation_type = dto.accommodation_type;
    if (dto.meal_plan) updatedDto.meal_plan = dto.meal_plan;
    if (dto.house_preference) updatedDto.house_preference = dto.house_preference;
    if (dto.health_info) updatedDto.health_info = dto.health_info;
    if (dto.emergency_contact_name) updatedDto.emergency_contact_name = dto.emergency_contact_name;
    if (dto.emergency_contact_phone) updatedDto.emergency_contact_phone = dto.emergency_contact_phone;
    if (dto.date_of_birth) updatedDto.date_of_birth = new Date(dto.date_of_birth);
